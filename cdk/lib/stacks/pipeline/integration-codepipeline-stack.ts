...
interface IntegrationCodepipelineProps extends IntegrationInterface {
...
export class IntegrationCodepipelineStack extends Stack {
  constructor(scope: Construct, id: string, props: IntegrationCodepipelineProps) {
